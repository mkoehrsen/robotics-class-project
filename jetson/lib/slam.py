...
def render_tag_points(tag2points):
    ...
    scale = min(height / (maxY - minY), width / (maxX - minX))

    for tag_id, point_pair in tag2points.items():

        p1 = ((point_pair[0][0] - minX) * scale, (point_pair[0][1] - minY) * scale)
        p2 = ((point_pair[1][0] - minX) * scale, (point_pair[1][1] - minY) * scale)

        for (p, color) in ((p1, "red"), (p2, "blue")):
            doc.append(
                ET.Element("circle", cx=f"{p[0]}", cy=f"{p[1]}", r="5", fill=color)
            )
...
def main():
    ...
    #     19 : [(3.9366813277302741, 15.838889235857884), (5.7602187644177416, 15.301671626938282)],
    #     20 : [(7.5551912861664823, 14.827861067095164), (9.3985415901691773, 14.243508646326813)],
    #     21 : [(12.298711920109973, 13.32563847590211), (14.042032819960561, 12.700948011602071)],
    #     22 : [(15.743587909422775, 12.216475580892704), (17.300643259026305, 11.454566086209782)],
    #     23 : [(19.020575631881105, 10.874312801286353), (20.853330582946654, 10.201428351967861)],
    #     24 : [(22.93847015380188, 9.0307398405251966), (24.726446503527541, 8.4391847541481617)],
    #     25 : [(26.513077737731553, 7.8239813125318971), (28.363586367320579, 6.8953166425646568)],
    #     9 : [(33.322556028032054, 5.562693738621336), (31.861675699473182, 3.6366842345437274)],
    #     10 : [(30.821939340094403, 1.9768623959794125), (29.840917786834545, 0.19485238577630692)],
    #     11 : [(28.837671866335576, -1.373819329316051), (27.88771972744231, -3.1498705838234118)],
    #     12 : [(26.773907850286736, -5.6696063551233511), (25.763101080239558, -7.4474932750420306)],
    #     13 : [(24.901046826186022, -9.0137155855634745), (24.06625113236213, -10.784002753634647)],
    #     14 : [(23.243635184528497, -12.390298893292812), (22.197161494646544, -14.010099695362918)],
    #     15 : [(20.47192823485425, -15.974737459503753), (19.382762030394851, -17.330167844535467)],
    #     16 : [(18.587693439112083, -18.72432987837221), (17.595034790625647, -20.325839959647141)],
    #     3 : [(16.882597154346641, -22.660578720073907), (15.204009475844121, -21.828607271878546)],
    #     4 : [(13.718769315320234, -21.099175277528879), (12.107495915108704, -20.306205602934128)],
    #     0 : [(7.8135910153422135, -17.391051697681995), (5.5342386860849082, -16.172658209291864)],
    #     1 : [(3.7871324286525798, -15.402064278129746), (1.8949495498438043, -14.540519154674449)],
    #     5 : [(10.967363617044159, -19.274560455591661), (9.3249248406029412, -18.310187550680844)]
    # }
    # render_tag_points(tag_world_points)
    # return
